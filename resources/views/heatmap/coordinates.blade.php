  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav">
      ...
      <script>
         ...
         //     //   var coords = responseObj[i].geometry.coordinates;
         //        latLng = new google.maps.LatLng(responseObj[i].latitude,responseObj[i].longitude);
         ...
         // return latLng;
                 ...
                 //     var location = coordinates[i].location;
                 //     console.log(location);
                     
                 // }
             // return [
                 // new google.maps.LatLng([0.00589, 37.072361],[0.034772, 37.120095],[-0.358833, 37.00244],[-0.16502, 37.07671],[0.01678, 37.07531],[0.0282, 37.0226],[-0.169488, 37.22767],[0.07194, 37.067642])
             //   new google.maps.LatLng(0.034772, 37.120095),
             //   new google.maps.LatLng(-0.358833, 37.00244),
             //   new google.maps.LatLng(0.0291, 37.00455),
             //   new google.maps.LatLng(-0.16502, 37.07671),
             //   new google.maps.LatLng(0.01678, 37.07531),
             //   new google.maps.LatLng(0.0282, 37.0226),
             //   new google.maps.LatLng(-0.169488, 37.22767),
             //   new google.maps.LatLng(0.07194, 37.067642),
             //   new google.maps.LatLng(0.07194, 37.13129),
             //   new google.maps.LatLng(0.02445, 37.069505),
             //   new google.maps.LatLng(0.0417, 37.02285),
             //   new google.maps.LatLng(0.0242, 37.09531),
             //   new google.maps.LatLng(0.0242, 37.09479),
             //   new google.maps.LatLng(-0.1741, 37.115),
             //   new google.maps.LatLng(0.02617, 37.11907),
             //   new google.maps.LatLng(0.02506, 37.18042),
             //   new google.maps.LatLng(0.03985, 37.08347),
             //   new google.maps.LatLng(0.03694, 37.24166),
             //   new google.maps.LatLng(0.06932, 37.00943),
             //   new google.maps.LatLng(0.02693, 37.00094)
             // ];
             //   new google.maps.LatLng(0.08601, -122.439947),
             //   new google.maps.LatLng(-0.358945, -122.439952),
             //   new google.maps.LatLng(-0.3597, -122.440030),
